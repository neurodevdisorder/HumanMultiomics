...
#### Here, we annotated the data from the previous differential expression analysis using ENSEMBL information for each gene and mapped the DEGs onto their chromosomal location.

```{r, echo = FALSE, warning=FALSE}
OrgDb <- org.Hs.eg.db
results_edgeR_hth_filt_coding2<- topTags(lrt_hth_filt_coding2, n = nrow(count_hth_filt_coding2), sort.by = "none")
head(row.names(results_edgeR_hth_filt_coding2))
